 ...
 */
router.get("/:accountId/orders/admin/:orderId", checkAbilities('read', 'OrderAdmin'), orders_controller.admin_order_detail);
 ...
 * @param orderId - id заказа
 */
router.get("/:accountId/orders/:orderId", checkAbilities('read', 'OrderUser'), orders_controller.user_order_detail);
 ...
 */
router.delete("/:accountId/orders/:orderId/delete/:titleId", checkAbilities('delete', 'TitleOrderUser'), titleOrders_controller.title_delete)
 ...
 * @param orderId - id заказа
 */
router.put("/:accountId/orders/:orderId/update", checkAbilities('update', 'TitleOrderUser'), titleOrders_controller.user_titleOrder_update_put);
 ...
 * @param orderId - id заказа
 */
router.put("/:accountId/orders/admin/update/:orderId", checkAbilities('update', 'TitleOrderAdmin'), titleOrders_controller.admin_titleOrder_update_put);
